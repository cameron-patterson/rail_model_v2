...
#ia, ib = rail_model_two_track_e_blocks(section_name="test", conditions="moderate", ex_blocks=np.array([[0, 0], [0, 0], [0, 0]]), ey_blocks=np.array([[0, 0], [0, 0], [0, 0]]), axle_pos_a=np.array([2.11, 2.22]), axle_pos_b=np.array([2.11, 2.22]))
