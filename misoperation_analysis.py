...
#ia, ib = rail_model_two_track_e_parallel(section_name="glasgow_edinburgh_falkirk", conditions="moderate", e_parallel=np.array([10]), axle_pos_a=np.array([]), axle_pos_b=np.array([]))
#fig, ax = plt.subplots(2, 1)
#ax[0].plot(ia[0], '.')
#ax[1].plot(ib[0], '.')
#plt.show()