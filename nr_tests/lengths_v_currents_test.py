...
def plot_lengths_v_currents_thresholds_rs():
    ...
    thresholds_br966f2 = np.load("../data/tc_type_lengths_v_currents/lengths_v_currents_thresholds_br867_br966f2_rs.npy")
    thresholds_br966f9 = np.load("../data/tc_type_lengths_v_currents/lengths_v_currents_thresholds_br867_br966f9_rs.npy")
...
def plot_lengths_v_currents_thresholds_ws():
    ...
    thresholds_br966f2 = np.load("../data/tc_type_lengths_v_currents/lengths_v_currents_thresholds_br867_br966f2_ws.npy")
    thresholds_br966f9 = np.load("../data/tc_type_lengths_v_currents/lengths_v_currents_thresholds_br867_br966f9_ws.npy")
...
#    save_lengths_v_currents_ws(type)
#    save_lengths_v_currents_thresholds_ws(type)
